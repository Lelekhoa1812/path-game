/* @ts-self-types="./map_loader_wasm.d.ts" */

/**
 * @param {any} request
 * @returns {any}
 */
export function generate_puzzle(request) {
    const ret = wasm.generate_puzzle(request);
    if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('map_loader_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
